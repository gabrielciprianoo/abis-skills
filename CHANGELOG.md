...
- `goldengate-skills` CLI (Node 18+, no dependencies) with `list`, `install`, `update` and `uninstall`, plus `--force`.
...
[0.1.0]: https://github.com/gabrielciprianoo/gg-skills/releases/tag/v0.1.0
